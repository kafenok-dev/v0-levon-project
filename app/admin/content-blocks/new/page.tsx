  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!error) {
        ...
        alert('Error creating content block: ' + error.message);
      }
    } catch (err) {
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Create a new content block</p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              placeholder="e.g., hero, about, testimonials"
            />
          </div>
          ...
          <div>
            ...
            />
            <p className="mt-1 text-sm text-gray-500">Enter valid JSON data</p>
          </div>
          ...
          <div className="flex gap-3">
            ...
            >
              {saving ? 'Creating...' : 'Create Content Block'}
            </button>
            <Link
              href="/admin/content-blocks"
